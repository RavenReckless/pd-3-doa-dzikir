    ...
    <div class="container py-5">
        <div class="row pt-5">
            <div class="col-lg-8">
                ...
                <div class="mb-5">
                    <img class="img-fluid rounded w-100 mb-4" src="{{ asset('assets/img/detail.jpg') }}" alt="Image" />
                    <p>
                    ...
                    <img class="img-fluid rounded w-50 float-left mr-4 mb-3" src="{{ asset('assets/img/blog-1.jpg') }}"
                        alt="Image" />
                    <p>
                    ...
                    <img class="img-fluid rounded w-50 float-right ml-4 mb-3" src="{{ asset('assets/img/blog-2.jpg') }}"
                        alt="Image" />
                    <p>
                        Diam dolor est labore duo invidunt ipsum clita et, sed et lorem
                        voluptua tempor invidunt at est sanctus sanctus. Clita dolores sit
                ...
                <div class="mb-5">
                    ...
                    <div class="media mb-4">
                        <img src="{{ asset('assets/img/user.jpg') }}" alt="Image"
