        ...
        <div class="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-6 xl:grid-cols-4 2xl:gap-7.5">
            ...
            <div
                ...
                <div class="mt-4 flex items-end justify-between">
                    <div>
                        <h4 class="text-title-md font-bold text-black dark:text-white">
                            {{ App\Models\Community::count() }}
                        </h4>
                        <span class="text-sm font-medium">Total Komunitas</span>
                    </div>

                </div>
            </div>
            <!-- Communities Card Item End -->

            <!-- Materi Dzikir Card Item Start -->
            <div
                class="rounded-sm border border-stroke bg-white px-7.5 py-6 shadow-default dark:border-strokedark dark:bg-boxdark">
                <div class="flex h-11.5 w-11.5 items-center justify-center rounded-full bg-meta-2 dark:bg-meta-4">
                ...
                <div class="mt-4 flex items-end justify-between">
                    <div>
                        <h4 class="text-title-md font-bold text-black dark:text-white">
                            {{ App\Models\MateriDzikir::count() }}
                        </h4>
                        <span class="text-sm font-medium">Total Materi Doa & Dzikir</span>
                    </div>
                </div>
            </div>
            <!-- Materi Dzikir Card Item End -->

            <!-- Shalawat Card Item Start -->
            <div
                class="rounded-sm border border-stroke bg-white px-7.5 py-6 shadow-default dark:border-strokedark dark:bg-boxdark">
                <div class="flex h-11.5 w-11.5 items-center justify-center rounded-full bg-meta-2 dark:bg-meta-4">
                    <svg class="fill-primary dark:fill-white" width="20" height="22" viewBox="0 0 20 22"
                ...
                <div class="mt-4 flex items-end justify-between">
                    <div>
                        <h4 class="text-title-md font-bold text-black dark:text-white">
                            {{ App\Models\Shalawat::count() }}
                        </h4>
                        <span class="text-sm font-medium">Total Shalawat</span>
                    </div>
                </div>
            </div>
            <!-- Shalawat Card Item End -->

            <!-- Sharing Experience Card Item Start -->
            {{-- <div
                class="rounded-sm border border-stroke bg-white px-7.5 py-6 shadow-default dark:border-strokedark dark:bg-boxdark">
                <div class="flex h-11.5 w-11.5 items-center justify-center rounded-full bg-meta-2 dark:bg-meta-4">
                ...
                <div class="mt-4 flex items-end justify-between">
                    <div>
                        <h4 class="text-title-md font-bold text-black dark:text-white">
                            {{ App\Models\SharedExperience::count() }}
                        </h4>
                        <span class="text-sm font-medium"></span>
                    </div>
                </div>
            </div> --}}
            <!-- Sharing Experience Card Item End -->
                ...
                <div>
                    <a href="messages.html"
                        ...
                        <div class="relative h-14 w-14 rounded-full">
                            <img src="{{asset('adminassets/images/user/user-03.png')}}" alt="User" />
                            <span
                    ...
                    <a href="messages.html"
                        class="flex items-center gap-5 px-7.5 py-3 hover:bg-gray-3 dark:hover:bg-meta-4">
                        <div class="relative h-14 w-14 rounded-full">
                            <img src="{{asset('adminassets/images/user/user-04.png')}}" alt="User" />
                            <span
                                class="absolute bottom-0 right-0 h-3.5 w-3.5 rounded-full border-2 border-white bg-meta-3"></span>
                        </div>
                    ...
                    <a href="messages.html"
                        class="flex items-center gap-5 px-7.5 py-3 hover:bg-gray-3 dark:hover:bg-meta-4">
                        <div class="relative h-14 w-14 rounded-full">
                            <img src="{{asset('adminassets/images/user/user-05.png')}}" alt="User" />
                            <span
                    ...
                    <a href="messages.html"
                        class="flex items-center gap-5 px-7.5 py-3 hover:bg-gray-3 dark:hover:bg-meta-4">
                        <div class="relative h-14 w-14 rounded-full">
                            <img src="{{asset('adminassets/images/user/user-02.png')}}" alt="User" />
                            <span
