...
@section('title', 'Edit Sharing Pengalaman')
    ...
    <main>
        <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
            ...
            <div
                ...
                <form action="{{ route('admin.sharing-dzikir.update', $sharing->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="p-6.5">
                        <!-- User Select Field -->
                        ...
                        <div class="mb-4.5">
                            ...
                            <input type="text"
                                ...
                                id="title" name="title" placeholder="Masukkan judul" value="{{ $sharing->title }}" />
                        </div>
                        ...
                        <div class="mb-4.5">
                            ...
                            <textarea placeholder="Masukkan pengalaman dzikir"
                                class="w-full rounded border-[1.5px] border-stroke bg-transparent px-5 py-3 font-normal text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary"
                                id="content" name="content" rows="4" value="{{ $sharing->content }}"></textarea>
                        </div>
