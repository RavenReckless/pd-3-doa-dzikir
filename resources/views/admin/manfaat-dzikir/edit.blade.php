...
<main>
    <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
      ...
      <div class="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark w-full">
        ...
        <form action="{{ route('admin.manfaat-dzikir.update', $manfaatDzikir->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="p-6.5">
                <!-- Title Field -->
                ...
                <div class="mb-4.5">
                    ...
                    <textarea 
                        ...
                        name="description" 
                        rows="4" 
                        value="{{ $manfaatDzikir->description }}"
                        required
                    ></textarea>
                </div>
