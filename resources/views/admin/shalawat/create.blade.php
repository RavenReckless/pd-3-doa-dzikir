    ...
    <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
      ...
      >
        ...
        <nav>
          <ol class="flex items-center gap-2">
            ...
            <li class="font-medium text-primary">Tambah Shalawat</li>
          </ol>
        </nav>
      </div>
      <!-- Breadcrumb End -->
      ...
      <div class="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark w-full">
        <div class="border-b border-stroke px-6.5 py-4 dark:border-strokedark">
          <h3 class="font-medium text-black dark:text-white">Form Tambah Shalawat</h3>
        </div>
        <form action="{{ route('admin.shalawat.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="p-6.5">
                <!-- Title Field -->
                <div class="mb-4.5">
                    ...
                    <input 
                        type="text" 
                        placeholder="Masukkan judul shalawat" 
                ...
                <div class="mb-4.5">
                    ...
                    <textarea 
                        placeholder="Masukkan bacaan shalawat" 
                        class="w-full rounded border-[1.5px] border-stroke bg-transparent px-5 py-3 font-normal text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary" 
                        id="bacaan" 
                        name="bacaan" 
                        rows="4" 
