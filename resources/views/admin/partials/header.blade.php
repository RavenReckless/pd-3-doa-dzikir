    ...
    <div class="flex flex-grow items-center justify-between px-4 py-4 shadow-2 md:px-6 2xl:px-11">
        <div class="flex items-center gap-2 sm:gap-4 lg:hidden">
            ...
            <a class="block flex-shrink-0 lg:hidden" href="index.html">
                <img src="{{ asset('adminassets/images/logo/logo-icon.svg') }}" alt="Logo" />
            </a>
        </div>
        ...
        <div class="flex items-center gap-3 2xsm:gap-7">
            <ul class="flex items-center gap-2 2xsm:gap-4">
                <li>
                    <!-- Dark Mode Toggler -->
                    <label :class="darkMode ? 'bg-cyan-500' : 'bg-stroke'"
                            ...
                            @foreach ($notifications as $notification)
                                <li>
                                    <a class="flex flex-col gap-2.5 border-t border-stroke px-4.5 py-3 hover:bg-gray-2 dark:border-strokedark dark:hover:bg-meta-4"
                                        href="#">
                                        <p class="text-sm">
                                            <span class="text-black dark:text-white">{{ $notification->message }}</span>
                                        </p>
                                        <p class="text-xs">{{ $notification->created_at->format('d M, Y') }}</p>
                                    </a>
                                </li>
                            @endforeach
                        </ul>
                        ...
                        <ul class="flex h-auto flex-col overflow-y-auto">
                            ...
                            <li>
                                <a class="flex gap-4.5 border-t border-stroke px-4.5 py-3 hover:bg-gray-2 dark:border-strokedark dark:hover:bg-meta-4"
                                    href="messages.html">
                                    <div class="h-12.5 w-12.5 rounded-full">
                                        <img src="{{ asset('adminassets/images/user/user-01.png') }}"
                                            alt="User" />
                                    </div>
                            ...
                            <li>
                                <a class="flex gap-4.5 border-t border-stroke px-4.5 py-3 hover:bg-gray-2 dark:border-strokedark dark:hover:bg-meta-4"
                                    href="messages.html">
                                    <div class="h-12.5 w-12.5 rounded-full">
                                        <img src="{{ asset('adminassets/images/user/user-03.png') }}"
                                            alt="User" />
                                    </div>
                            ...
                            <li>
                                <a class="flex gap-4.5 border-t border-stroke px-4.5 py-3 hover:bg-gray-2 dark:border-strokedark dark:hover:bg-meta-4"
                                    href="messages.html">
                                    <div class="h-12.5 w-12.5 rounded-full">
                                        <img src="{{ asset('adminassets/images/user/user-04.png') }}"
                                            alt="User" />
                                    </div>
                            ...
                            <li>
                                <a class="flex gap-4.5 border-t border-stroke px-4.5 py-3 hover:bg-gray-2 dark:border-strokedark dark:hover:bg-meta-4"
                                    href="messages.html">
                                    <div class="h-12.5 w-12.5 rounded-full">
                                        <img src="{{ asset('adminassets/images/user/user-02.png') }}"
                                            alt="User" />
                                    </div>
